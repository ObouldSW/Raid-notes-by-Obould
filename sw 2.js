const CACHE_NAME = 'raid-notes-v6';
...
// Network-first for everything: always pull the latest version when there's
// a signal, so pushing an update means the very next refresh shows it.
// Cache is purely a fallback for when there's no connection at all.
